...
if __name__ == '__main__':
    ...
    parser.add_argument('output', help='Output directory for nlohmann.natvis')
    ...
    template = env.get_template('nlohmann.natvis.j2')
    natvis = template.render(namespaces=namespaces)

    with open(os.path.join(args.output, 'nlohmann.natvis'), 'w') as f:
        f.write(natvis)
